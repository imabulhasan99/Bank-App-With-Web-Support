...
if( !empty( $_GET['id'] ) ){
$customerId = $_GET['id'];
$customer->customerDetailsTransaction( $customerId);
        ...
        <header class="py-10">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">
              Transactions of <?php echo $customer->customerDetailsTransaction( $customerId )['name'][0]['name'] ?>
            </h1>
          </div>
        </header>
      </div>
              ...
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  <p class="mt-2 text-sm text-gray-700">
                    List of transactions made by <?php echo $customer->customerDetailsTransaction( $customerId )['name'][0]['name'] ?>
                  </p>
                </div>
              </div>
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                     ...
                     <?php foreach( $customer->customerDetailsTransaction( $customerId )['data'] as $customer ){ ?>
                        <tr>
                          <td
                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-800 sm:pl-0">
                            <?php echo $customer['recipient_name'] ?>
                          </td>
                          <td
                            class="whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-0">
                            <?php echo $customer['recipient_email'] ?>
                          </td>
                          <td
